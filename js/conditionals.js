...
var confirmNumber = confirm("Would you like to enter a number?"); {
	if (confirmNumber === true) {
		var userNumber = prompt("Enter a number now");
			if (isNaN(userNumber) === true)
				alert("That is not a number.");
			if (userNumber % 2 === 0 && userNumber >= 0) {
				alert("You entered an even number!");
				alert("If you add 100 to your number, you get: " + (Number(userNumber) + 100) + ". Neat!");
...
function calculateTotal (luckyNum , totalAmount) {
	if (luckyNum === 0) {
		...
		return "$" + (Number(totalAmount) * 0.9).toFixed(2);}
	else if (luckyNum === 2) {
		return "$" + (Number(totalAmount) * 0.75).toFixed(2);}
	else if (luckyNum === 3) {
		return "$" + (Number(totalAmount) * 0.65).toFixed(2);}
	else if (luckyNum === 4) {
		return "$" + (Number(totalAmount) * 0.5).toFixed(2);}
	else if (luckyNum === 5) {
		return "$0.00";}
	}
...
var totalBill = prompt("What is the amount of your total bill?");
